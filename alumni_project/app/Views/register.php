    ...
    <div id="container">
        ...
        <div id="u0_div" class="container">
            ...
            <form id="create-form" action="/register/save" method="post" class="register-form">
                ...
                <option value="คณะวิทยาศาสตร์และเทคโนโลยี (สาขาพยาบาลศาสตร์)">คณะวิทยาศาสตร์และเทคโนโลยี (สาขาพยาบาลศาสตร์)</option>
                <option value="ปริญาญาตรี (4 ปี) ภาคกศ.พป.">ปริญาญาตรี (4 ปี) ภาคกศ.พป.</option>
                <option value="ปริญาญาตรี (4 ปี) ภาคกศ.พป. วันธรรมดา (ภาคเช้า)">ปริญาญาตรี (4 ปี) ภาคกศ.พป. วันธรรมดา (ภาคเช้า)</option>
                <option value="ปริญาญาตรี (4 ปี) ภาคกศ.พป. วันธรรมดา (ภาคค่ำ)">ปริญาญาตรี (4 ปี) ภาคกศ.พป. วันธรรมดา (ภาคค่ำ)</option>
                <option value="วิชาโท">วิชาโท</option>
                <option value="ปริญาญาตรี (4 ปี) โครงการนักศึกษานานาชาติ">ปริญาญาตรี (4 ปี) โครงการนักศึกษานานาชาติ</option>
                <option value="ปริญาญาตรี (หลังอนุปริญญา) ภาคปกติ">ปริญาญาตรี (หลังอนุปริญญา) ภาคปกติ</option>
                <option value="ปริญาญาตรี (หลังอนุปริญญา) ภาคปกติ ภาคค่ำ">ปริญาญาตรี (หลังอนุปริญญา) ภาคปกติ ภาคค่ำ</option> 
                <option value="ปริญาญาตรี (หลังอนุปริญญา) ภาคกศ.พป.">ปริญาญาตรี (หลังอนุปริญญา) ภาคกศ.พป.</option>
                <option value="ปริญาญาตรี (หลังอนุปริญญา) ภาคกศ.พป. วันธรรมดา (ภาคเช้า)">ปริญาญาตรี (หลังอนุปริญญา) ภาคกศ.พป. วันธรรมดา (ภาคเช้า)</option>
                <option value="ปริญาญาตรี (หลังอนุปริญญา) ภาคกศ.พป. วันธรรมดา (ภาคค่ำ)">ปริญาญาตรี (หลังอนุปริญญา) ภาคกศ.พป. วันธรรมดา (ภาคค่ำ)</option>
                ...
                <option value="ปริญาญาตรี (5 ปี) ภาคกศ.พป. วันธรรมดา (ภาคเช้า)">ปริญาญาตรี (5 ปี) ภาคกศ.พป. วันธรรมดา (ภาคเช้า)</option>
                <option value="ปริญาญาตรี (5 ปี) ภาคกศ.พป. วันธรรมดา (ภาคค่ำ)">ปริญาญาตรี (5 ปี) ภาคกศ.พป. วันธรรมดา (ภาคค่ำ)</option>
