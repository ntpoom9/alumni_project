                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="/search_page" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div id="u0_div" class="container">
            ...
            <div class="form-row">
                <div class="form-group" id="regis0">
                    ...
                    <input type="password" name="confpassword" id="confpassword" value="<?= set_value('confpassword'); ?>" >
                    <span id="error"><?php  if (isset($validation)) : ?>
            ...
            <div class="form-row">
                <div class="form-group" id="regis0">
                    ...
                    <input type="text" name="FName_eng" id="FName_eng"  value="<?= set_value('FName_eng'); ?>" onkeyup="upperCharacter()">
                   
                </div>

                <div class="form-group">
                    <label for="LnEng">นามสกุล(อังกฤษ)</label>
                    <input type="text" name="LName_eng" id="LName_eng"  value="<?= set_value('LName_eng'); ?>" onkeyup="upperCharacter()">
            ...
            <div class="form-row">
                <div class="form-group" id="regis0">
                    ...
                    <input type="text" name="id_cardnumber" id="id_cardnumber"  value="<?= set_value('id_cardnumber'); ?>">
            ...
            <div class="form-row">
                <div class="form-group" id="regis0">
                    ...
                    <input style="width: 200px; height:30px" type="date" name="d_m_y_birth" id="d_m_y_birth" placeholder=""  value="<?= set_value('d_m_y_birth'); ?>">
                    <span id="error"><?php  if (isset($validation)) : ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="province_birth" id="province_birth"  value="<?= set_value('province_birth'); ?>">
                    <span id="error"><?php  if (isset($validation)) : ?>
            ...
            <div class="form-row">
                ...
                <div class="form-group" id="regis0">
                    ...
                    <input style="width: 98px;" type="text" name="nationality" id="nationality"  value="<?= set_value('nationality'); ?>">
                    
                </div>
                <div class="form-group">
                    <label for="name">ศาสนา</label>
                    <input style="width: 98px;" type="text" name="religion" id="religion"  value="<?= set_value('religion'); ?>">
            ...
            <div class="form-row">
                <div class="form-group" id="regis0">
                    ...
                    <input style="width: 200px;" type="text" name="Address" id="Address"  value="<?= set_value('Address'); ?>" placeholder="เช่น 96/4 ม.18">
                    <span id="error"><?php  if (isset($validation)) : ?>
                ...
                <div class="form-group">
                    ...
                    <input style="width: 98px;" type="text" name="SubDistrict" id="SubDistrict"  value="<?= set_value('SubDistrict'); ?>">
                    <span id="error"><?php  if (isset($validation)) : ?>
            ...
            <div class="form-row">
                <div class="form-group" id="regis0">
                    ...
                    <input style="width: 98px;" type="text" name="District" id="District"  value="<?= set_value('District'); ?>">
                    
                </div>
                <div class="form-group">
                    <label for="name">จังหวัด</label>
                    <input style="width: 98px;" type="text" name="Province" id="Province"  value="<?= set_value('Province'); ?>">
                   
                </div>
                <div class="form-group">
                    <label for="name">รหัสไปรษณีย์</label>
                    <input style="width: 98px;" type="text" name="Zipcode" id="Zipcode"  value="<?= set_value('Zipcode'); ?>">
